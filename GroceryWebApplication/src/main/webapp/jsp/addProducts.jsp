...
<body>
    ...
    <input type="number" class="form-control" name="pDiscount" aria-describedby="products" placeholder="Enter here">
     ...
     <div class="form-group">
    <label for="pStock">Enter Stock</label>
    <input type="number" class="stock" name="stock" aria-describedby="products" placeholder="Enter here">
    </div>
   		...
   		<label for="categoryId">select category </label>
					...
					<option value="9">Special Offers</option>
					</select>
				</div>
